...
top-level declarations. The complete build executes 763 audit commands covering
699 distinct declarations and reports no axiom dependency. Source integrity is
checked with either:
